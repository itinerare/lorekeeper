<li class="list-group-item">
    ...
    <div id="openRarityBoxForm" class="collapse">
        ...
        <div class="form-group">
            ...
            {!! Form::select('item_id', App\Models\Item\Item::released()->whereNotNull('data')->whereRaw('JSON_EXTRACT(`data`, \'$.rarity\') = ' . $tag->data)->orderBy('name')->pluck('name','id')->toArray(), null, ['class' => 'form-control rarityBox selectize', 'placeholder' => 'Select an Item']) !!}
        </div>
        <script>
