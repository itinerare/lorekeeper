    ...
    public function createDesignUpdateRequest($character, $user) {
        ...
        try {
            ...
            if (!$character->isAvailable) {
                throw new \Exception('This '.($character->is_myo_slot ? 'MYO slot' : 'character').' is currently unavailable.'.($character->is_disabled ? '' : ' Please cancel the trade or transfer before creating a design update.'));
            }
